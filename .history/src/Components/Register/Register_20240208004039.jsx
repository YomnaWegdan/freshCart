          ...
          <div className="row g-5 h-100 align-items-center  align-content-center">
            ...
            <div className=" col-md-12">
              ...
              <input
                ...
                />
                {formik.errors.name && formik.touched.?<div className='alert alert-danger p-2'>{formik.errors.name}</div>:''}
                ...
                <input
                  ...
                  onBlur={formik.handleBlur}
                />
                {formik.errors.password?<div className='alert alert-danger p-2'>{formik.errors.password}</div>:''}
