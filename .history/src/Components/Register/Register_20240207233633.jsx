        ...
        <div className="container h-100">
          <div className="row g-5 h-100 align-items-center  align-content-center">
            ...
            <div className=" col-md-12">
              ...
              <form >
              <input
                  className=" form-control border-top-0 border-start-0 border-end-0  border-bottom-3 p"
                ...
                <input
                  className=" form-control border-top-0 border-start-0 border-end-0  border-bottom-3 py-5"
