        ...
        <>
          {data?.data.data.map((product) => (
            <div className="row  my-5 g-5 align-items-center border-1 border-bottom" key={product.id}>
              ...
              <div className=" col col-lg-10 d-flex  align-items-center justify-content-center ">
              <div className="col-md-5">
                ...
                <div className="d-flex flex-column  justify-content-between py-3 font-sm">
                  ...
                  <button onClick={()=> mutate(product.id)} className="btn bg-main text-light w-auto ">Remove</button>
