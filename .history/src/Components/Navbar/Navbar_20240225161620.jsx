...
export default function Navbar() {
  ...
  let { data:wishListData } = useGetWishList("getWishList", getWishList);
  console.log(wishListData?.data.count)
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              {userToken != null ? (
                ...
                <li className="nav-item position-relative ms-3">
                    ...
                    <div className="cartIcon  rounded-circle   ">
                        {data?.data.numOfCartItems|| null}
                      </div>
                    </NavLink>
                  </li>
