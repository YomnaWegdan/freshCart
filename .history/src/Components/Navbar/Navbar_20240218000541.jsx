            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              {userToken != null ? (
                <>
                  ...
                  <li className="nav-item position-relative ms-auto">
                    <NavLink className="nav-link " to={"/cart"}>
                    <i class="fa-solid fa-cart-shopping"></i>                      <div className="text-main p-2 py-0 rounded-circle position-absolute top-0 end-0 bg-success ">
