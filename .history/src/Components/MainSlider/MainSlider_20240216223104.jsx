  ...
  return (
    ...
    <Slider {...settings}>
        {slide.map((image , index)=> 
          <img src={image} alt='slide-img' key={index} className="w-100 object-fit-cover" height={400}/>)}
    </Slider>
    </div> 
    <div className='col-md-3'>
    {img.map((img , index)=> 
        <img src={img} alt='slide-img' key={index} className="w-100 object-fit-cover" height={200}/>)}
    </div>
