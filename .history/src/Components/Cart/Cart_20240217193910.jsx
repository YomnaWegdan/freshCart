...
import { getCartItems, removeCartItem, useGetCart } from '../../CustomHooks/useCart';
...
export default function Cart() {
  ...
  //delete
  let {  data:deleteData , mutate } =  useGetCart('deleteCart' ,removeCartItem);
    ...
    {data.data.data.products.map((product)=> 
      ...
      <div className='col-md-10'>
        <div className='item'>
          ...
          <button onClick={()=> mutate(product.)}  className='btn'><i className=' fas fa-trash-can text-danger '></i>Remove</button>
        </div>
      </div>
      <div className='col-md-1'>
      <div className='count'>
