...
export default function Cart() {
  ...
  function checkOut(values){
   ...
   function getCartItems(cartId , shippingAddress){ 
    return axios.post(`https://ecommerce.routemisr.com/api/v1/orders/checkout-session/65ce8eb5174ff812a603cd8b?url=http://localhost:3000` , 
    {
        headers:{
