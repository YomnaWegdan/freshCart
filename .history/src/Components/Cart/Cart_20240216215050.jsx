...
export default function Cart() {
  ...
  const {getCartItems , removeCartItem}= useContext(CartContext);
    ...
    {cart.data.products.map((product)=> 
      ...
      <div className='col-md-10'>
        <div className='item'>
          ...
          <button onClick={()=> removeItem(product.p)} className='btn'><i className=' fas fa-trash-can text-danger '></i>Remove</button>
        </div>
      </div>
      <div className='col-md-1'>
      <div className='count'>
