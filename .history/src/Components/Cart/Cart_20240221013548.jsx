...
export default function Cart() {
  ...
  return (
    ...
    {data.data.data.products.map((product)=> 
      ...
      <NavLink to={'/shippingaddress'} className='btn bg-main text-light' data-bs-toggle="modal" data-bs-target="#staticBackdrop">Online Payment</NavLink>
...
<div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <input onChange={formik.handleChange} id='details' name='details' className=' form-control' placeholder='Details'/>
      <input onChange={formik.handleChange} id='phone' name='phone mb-3' className=' form-control' placeholder='Details'/>
      <input onChange={formik.handleChange} id='details' name='details mb-3' className=' form-control' placeholder='Details'/>
