...
<div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <input onChange={formik.handleChange} id='phone' name='phone' className=' form-control mb-3' placeholder='Details'/>
      <input onChange={formik.handleChange} id='details' name='details mb-3' className=' form-control mb-3' placeholder='Details'/>
