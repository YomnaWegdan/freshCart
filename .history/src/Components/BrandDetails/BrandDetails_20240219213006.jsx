...
export default function BrandDetails() {
  ...
  return (
    ...
    <div className='vh-100 row justify-content-center align-items-center align-items-center'>
    <div className="row justify-content-center align-items-center align-items-center border h-50 ">
