...
export default function BrandDetails() {
  ...
  return (
    ...
    <div className='col-md-6 h-50 bg-light d-flex align-items-center justify-content-center rounded-2'>
       <img src={data.image} alt={data.title} key={data._id} className="w-50"/>
    </div> 
    <div className='col-md-6 h-50 bg-light d-flex align-items-center justify-content-center'>
