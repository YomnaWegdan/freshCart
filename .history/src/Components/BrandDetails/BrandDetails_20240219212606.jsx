...
export default function BrandDetails() {
  ...
  return (
    <Fragment >
    <div className="row justify-content-center align-items-center align-items-center bg-success-subtle  vh-100 ">
    <div className='col-md-6'>
       <img src={data.image} alt={data.title} key={data._id} className="w-"/>
    </div> 
    <div className='col-md-6'>
