    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <span className="wishList-btn "><i  onClick={()=>{return on heart? wishListMutate(product.id): ()=> removeWishlistItemMutate(product.id)}} style={heart?{color:'red'}:{color:'black'}} className="fas fa-heart cursor-pointer "></i></span> 
