...
export default function FeaturedProducts() {
  ...
  function searchFunc(e){
    ...
    let newArray= data?.filter((ele)=>ele.title.toLowerCase().trim().includes(term.title.toLowerCase().trim()))
    setSearch(newArray)
  ...
  return (
    ...
    {isLoading ? (
             <Loading/>
              ...
              <input className=" search-input form-control w-100 mx-auto mt-5 " onChange={(e)=>searchFunc(e)}/>
              </div>
              ...
              {search.length?search.map((product)=>                
                <div className=" col-lg-2 col-md-4 col-sm-6 position-relative" key={product.id}>
                 ...
                 <ProductComp product={product}/></div>):
                 data?.map((product)=>
                  <div className=" col-lg-2 col-md-4 col-sm-6 position-relative" key={product.id}>
