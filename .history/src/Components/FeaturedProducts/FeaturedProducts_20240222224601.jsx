    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <span className="wishList-btn " onClick={()=>re{heart? wishListMutate(product.id):''}}><i style={heart?{color:'red'}:{color:'unset'}} onClick={()=>setHeart(!heart)} className="fas fa-heart cursor-pointer "></i></span> 
