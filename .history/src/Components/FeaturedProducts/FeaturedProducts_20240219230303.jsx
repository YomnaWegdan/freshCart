...
export default function FeaturedProducts() {
  ...
  console.log(wishListData.data.message)

  if(isLoading) return <Loading></Loading>
  if(isEZZrror) return <h3>{error.message}</h3>
    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <i onClick={()=> wishListMutate(product.id)} className="fas fa-heart position-absolute top-0 end-0 cursor-pointer "></i>
