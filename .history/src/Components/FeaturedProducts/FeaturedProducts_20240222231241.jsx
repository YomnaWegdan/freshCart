    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                product={product}
                heart={heart}
                data={data} mutate={mutate} wishListMutate={wishListMutate} removeWishlistItemMutate={removeWishlistItemMutate}
              />
...
function ProductComponent({product, data, heart, toggleHeart, mutate,wishListMutate,removeWishlistItemMutate}) {
  ...
  //               <span className="wishList-btn "><i  onClick={()=>{return  heart? wishListMutate(product.id): ()=> removeWishlistItemMutate(product.id)}} style={heart?{color:'red'}:{color:'black'}} className="fas fa-heart cursor-pointer "></i></span> 
