    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <button className="wishList-btn btn text "><i  onClick={()=>{return  heart? wishListMutate(product.id): ()=> removeWishlistItemMutate(product.id)}} style={heart?{color:'red'}:{color:'black'}} className="fas fa-heart cursor-pointer "></i></button> 
