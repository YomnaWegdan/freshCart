    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <span className="wishList-btn " onClick={()=>{return heart? wishListMutate(product.id): ()=> removeWishlistItemMutate(product.id)}}><i style={heart?{color:'red'}:{color:'blach'}} onClick={()=>setHeart(!heart)} className="fas fa-heart cursor-pointer "></i></span> 
