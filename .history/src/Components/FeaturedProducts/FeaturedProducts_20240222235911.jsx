    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <ProductComp key={product.id} product={product} heart={heart}
                    setHeart={setHeart} wishListMutate = {wishListMutate} mutate={mutate}
                    removeWishlistItemMutate={removeWishlistItemMutate}/>
                </div>
...
function ProductComp({ product, heart, setHeart, wishListMutate, removeWishlistItemMutate, mutate }) {
    ...
    <Fragment>
      <div className="product p-3">
        <button onClick={() => setHeart(!heart)} className="wishList-btn btn ">
          {heart ? 
            <i onClick={() => { wishListMutate(product.id) }} className="fas fa-heart cursor-pointer text-danger"></i>
            :
