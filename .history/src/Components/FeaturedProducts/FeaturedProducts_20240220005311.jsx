    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <button className="wishList-btn btn btn-success" onClick={()=>wishListMutate(product.id)}><i style={heart?(color:'text-main'):c} onClick={()=>setHeart(!heart)} className="fas fa-heart cursor-pointer "></i></button> 
