    ...
    {isLoading ? (
             <Loading/>
              ...
              {data.map((product)=>
                ...
                <button className="wishList-btn btn btn-success" onClick={()=>wishListMutate(product.id)}><i onClick={()=>setHeart(!heart) sty} className="fas fa-heart cursor-pointer "></i></button> 
