...
It looks like you're trying to conditionally render the "Verify" button based on the response from your API call. However, there's a syntax error in your conditional rendering. You're missing the conditional operator (? :) after the loading spinner.
...
{loading ? (
  ...
  dataApi.statusMsg === "success" ? (
    <button type="submit" className="btn bg-main text-white" place>
      Verify
    </button>
  ) : (
